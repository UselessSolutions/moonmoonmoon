...
import useless.moonsteel.backpack.BackpackProxy;
...
public class MoonSteelItems {
	...
	public static final Item ARMOR_HELMET_MOONSTEEL = new ItemBuilder(MOD_ID)
	...
	public static final Item ARMOR_CHESTPLATE_MOONSTEEL = new ItemBuilder(MOD_ID)
	...
	public static final Item ARMOR_LEGGINGS_MOONSTEEL = new ItemBuilder(MOD_ID)
	...
	public static final Item ARMOR_BOOTS_MOONSTEEL = new ItemBuilder(MOD_ID)
	...
	public static final Item STAR_FALLEN = new ItemBuilder(MOD_ID)
		.build(new Item("star.fallen", MOD_ID + ":item/star_fallen", MoonSteel.itemId++));
	public static final Item STAR_CONNECTED = new ItemBuilder(MOD_ID)
		.setStackSize(1)
		.build(new ItemConnectedStar("star.connected", MOD_ID + ":item/star_connected", MoonSteel.itemId++));

	// TODO stop it from naging me here
