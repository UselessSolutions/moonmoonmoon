...
public class MoonSteelItems {
	...
	public static Item ARMOR_HELMET_MOONSTEEL = new ItemBuilder(MOD_ID)
		.build(new ItemArmor("helmet.moonsteel", MOD_ID + "item/armor_helmet_moonsteel", MoonSteel.itemId++, moonSteelArmor, 0));
	public static Item ARMOR_CHESTPLATE_MOONSTEEL = new ItemBuilder(MOD_ID)
		.build(new ItemArmor("chestplate.moonsteel", MOD_ID + "item/armor_chestplate_moonsteel", MoonSteel.itemId++, moonSteelArmor, 1));
	public static Item ARMOR_LEGGINGS_MOONSTEEL = new ItemBuilder(MOD_ID)
		.build(new ItemArmor("leggings.moonsteel", MOD_ID + "item/armor_leggings_moonsteel", MoonSteel.itemId++, moonSteelArmor, 2));
	public static Item ARMOR_BOOTS_MOONSTEEL = new ItemBuilder(MOD_ID)
		.build(new ItemArmor("boots.moonsteel", MOD_ID + "item/armor_boots_moonsteel", MoonSteel.itemId++, moonSteelArmor, 3));
